...
public class CloudinaryService {
    ...
    public Map<String, Object> uploadProfilePicture(MultipartFile file, String folder) throws IOException{
        String oiriganelFilename = file.getOriginalFilename();
        if(oiriganelFilename == null || oiriganelFilename.isEmpty()){
            ...
            String newName = oiriganelFilename.substring(0, oiriganelFilename.lastIndexOf('.'));
